...
int main() {
    ...
    write_program_to_file(loaded_machine, "test.roy");
    loaded_machine = read_program_from_file(loaded_machine, "test.roy");
    size_t num_instructions = loaded_machine->program_size;
    for (size_t ip = 0; ip < num_instructions; ip++) {
